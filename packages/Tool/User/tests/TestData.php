...
class TestData
{
    ...
    public function spotEmptyData(): array
    {
        ...
        $results['spotIconGenreComment'] = new \Tool\User\Domain\Models\SpotIconGenreComment\StoreData($spotIconGenreComment);
        $results['spotIconStatus'] = new \Tool\User\Domain\Models\SpotIconStatus\StoreData($spotIconStatus);
        $results['spotPrice'] = new \Tool\User\Domain\Models\SpotPrice\StoreData($spotPrice);
    ...
    public function requestUserUpdate(): array
    {
        ...
        $results['user']['email'] = 'user@hoge.co.jp';
