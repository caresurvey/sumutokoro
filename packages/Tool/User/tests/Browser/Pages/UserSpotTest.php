...
class UserSpotTest extends DuskTestCase
{
    /**
     * @test
     */
    public function 事業所管理テスト()
    {
        $this->browse(function (Browser $browser) {
            ...
            // 入力
            $browser->visit('/user/spot');
            $browser->assertSee('10件がみつかりました');
            $browser->click('#SpotName10');
            $browser->pause(1000);
            $browser->assertSee('事業所編集');
            ...
            $browser->scrollIntoView('#SpotAreaCenter')->assertSelected('#SpotAreaCenter', '3');
            $browser->scrollIntoView('#SpotCategory')->assertSelected('#SpotCategory', '3');
            $browser->scrollIntoView('#SpotName')->assertInputValue('#SpotName', '追加事業所変更');
            ...
            $browser->assertInputValue('#SpotAddress', '追加住所変更');
