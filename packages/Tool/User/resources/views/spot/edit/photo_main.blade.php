  ...
  <div class="flex justify-center items-center w-full relative">
    ...
    <label for="UploadPhotoData"
      ...
      <div class="flex flex-col justify-center items-center pt-5 pb-6 text-center">
        ...
        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">メイン画像はまだ登録されていません。<br>ここをクリックして画像を選択して下さい。
        </p>
        <p class="text-xs text-gray-500 dark:text-gray-400">画像は「PNG」か「JPG」のみで、サイズは「1200x800ピクセル」を推奨します)</p>
      </div>
