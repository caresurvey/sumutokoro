...
use Tool\Admin\Domain\Models\DesignerPhoto\DesignerPhotoList;

class AdminDesignerPhoto
{
    /**
     * 表示ボタン
     *
     ...
     * @return string
     */
    public static function displayLists(DesignerPhotoList $photoList)
    {
        // 初期化
        $result = '';
    ...
    public static function displayInput()
    {
        ...
        $result .= '<input type="hidden" name="designer[photo]" id="photoData" value="">';
        $result .= '</div>';
