...
class UpdateRequestTest extends TestCase
{
    ...
    public function dataProvider(): array
    {
        return [
            ...
            'enabled成功' => ['enabled', '0', true],
            'enabled成功2' => ['enabled', '1', true],
            'enabled失敗-空白' => ['enabled', '', false],
            'enabled失敗-空' => ['enabled', null, false],
            'enabled失敗-数値以外' => ['enabled', 'a', false],
            'enabled失敗-2以上' => ['enabled', '2', false],
            ...
            'is_authenticated成功' => ['is_authenticated', '0', true],
            'is_authenticated成功2' => ['is_authenticated', '1', true],
            'is_authenticated失敗-空白' => ['is_authenticated', '', false],
            'is_authenticated失敗-空' => ['is_authenticated', null, false],
            'is_authenticated失敗-数値以外' => ['is_authenticated', 'a', false],
            'authenticated_msg成功' => ['authenticated_msg', 'FAX', true],
            'authenticated_msg失敗-空' => ['authenticated_msg', null, false],
            /*
            ...
            */
            ...
            'role_id成功' => ['role_id', 1, true],
            'role_id失敗-範囲外' => ['role_id', '0', false],
            'role_id失敗-空白' => ['role_id', '', false],
            'role_id失敗-空' => ['role_id', null, false],
            'role_id失敗-数値以外' => ['role_id', 'a', false],
