...
class UpdateRequestTest extends TestCase
{
    ...
    public function dataProvider(): array
    {
        return [
            ...
            'is_meeting成功' => ['is_meeting', '1', true],
            'is_meeting失敗-範囲外' => ['is_meeting', '2', false],
            'is_meeting失敗-空白' => ['is_meeting', '', false],
            'is_meeting失敗-空' => ['is_meeting', null, false],
            ...
            'area_center_id成功' => ['area_center_id', '1', true],
            'area_center_id失敗-範囲外' => ['area_center_id', '0', false],
            'area_center_id失敗-空白' => ['area_center_id', '', false],
            'area_center_id失敗-空' => ['area_center_id', null, false],
            'area_center_id失敗-数値以外' => ['area_center_id', 'a', false],
            ...
            'company_id成功' => ['company_id', 1, true],
            'company_id失敗-範囲外' => ['company_id', '0', false],
            'company_id失敗-空白' => ['company_id', '', false],
            'company_id失敗-空' => ['company_id', null, false],
            'company_id失敗-数値以外' => ['company_id', 'a', false],
            ...
            'spot_plan_id成功' => ['spot_plan_id', 1, true],
            'spot_plan_id失敗-範囲外' => ['spot_plan_id', '0', false],
            'spot_plan_id失敗-空白' => ['spot_plan_id', '', false],
            'spot_plan_id失敗-空' => ['spot_plan_id', null, false],
            'spot_plan_id失敗-数値以外' => ['spot_plan_id', 'a', false],
            'trade_area_id成功' => ['trade_area_id', 1, true],
            'trade_area_id失敗-範囲外' => ['trade_area_id', '0', false],
            'trade_area_id失敗-空白' => ['trade_area_id', '', false],
            'trade_area_id失敗-空' => ['trade_area_id', null, false],
            'trade_area_id失敗-数値以外' => ['trade_area_id', 'a', false],
        ];
    }
}
