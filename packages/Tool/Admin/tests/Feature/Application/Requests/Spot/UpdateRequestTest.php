...
class UpdateRequestTest extends TestCase
{
    ...
    public function dataProvider(): array
    {
        return [
            ...
            'area_branch_id成功' => ['area_branch_id', '1', true],
            'area_branch_id失敗-範囲外' => ['area_branch_id', '0', false],
            'area_branch_id失敗-空白' => ['area_branch_id', '', false],
            'area_branch_id失敗-空' => ['area_branch_id', null, false],
            'area_branch_id失敗-数値以外' => ['area_branch_id', 'a', false],
