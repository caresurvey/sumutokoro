...
@section('title', '管理画面ログイン｜' . config('myapp.site_name'))

@section('content')

  <form name="form" method="POST" action="{{ asset('/') }}{{config('myapp.app_admin_prefix')}}/login">
    @csrf
    ...
    <div class="w-screen h-screen flex items-center justify-center">
      <div class="w-3/5">
        ...
        <div class="flex justify-center mb-5">
          <img src="{{asset('/')}}img/admin/pages/login/logo.png" alt="すむところ.com" class="w-2/5">
        </div>
        ...
        <div class="rounded-md bg-white p-20 shadow w-full mb-10">
          ...
          <div class="mb-3">
            ...
            <input type="email" name="email" id="LoginEmail"
                   ...
                   value="{{old('email', 'root@hoge.co.jp')}}" placeholder="メールアドレスを入れてください">
          </div>
