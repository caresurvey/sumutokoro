  ...
  <div class="shadow bg-white rounded-xl p-4 md:px-10 md:py-10">
    ...
    <div class="bg-gray-50 border border-gray-200 rounded-md mb-4 p-2 md:p-3 md:mb-8">
      <ul class="flex flex-wrap">
        ...
        <li class="p-1 w-1/5">
          <a href="{{asset('/')}}spot/?{{$link}}" class="link-primary w-full inline-block rounded-full hover:bg-primary hover:text-white text-md py-1 px-4">{{$area['name']}}（{{$area['spots_count']}}）</a>
        </li>
        @endif
        @endforeach
      </ul>
