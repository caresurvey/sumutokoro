            ...
            <div class="hidden sm:block">
              <div class="flex border-b border-gray-200 text-sm mb-3 pb-3 sm:mb-3 sm:pb-3">
                <div class="mr-4 w-2/5">
                  @if(!empty($spot['spot_main_image']['name']))
                    <a href="{{asset('/')}}spot/{{$spot['id']}}" class="hover:opacity-90 spotPhoto">
                      <img src="{{asset('/')}}photos/spots/{{$spot['spot_main_image']['name']}}/{{$spot['spot_main_image']['name']}}_2l.jpg"
                ...
                <div class="w-3/5">
                  ...
                  <div class="bg-gray-50 border border-gray-100 rounded mb-4 p-3 hidden md:block">
                    <div class="flex items-center mb-3">
                      ...
                      <div class="tracking-wider font-bold">
                        <span class="pr-1 text-md md:text-xl">{{number_format($spot['monthly_price_min'])}}</span> 円
                        @if($spot['for_check_monthly'])〜@endif
                        @if($spot['monthly_price_max'] > 0)<span class="pr-1 text-md md:text-xl">{{number_format($spot['monthly_price_max'])}}</span>
                         円@endif
                      </div>
                    </div>
                  ...
                  <div class="mb-2 text-md tracking-wider md:text-base">
                    {{$spot['heading']}}
                  </div>
                </div>
              </div>
              ...
              <div class="bg-gray-50 border border-gray-100 rounded mb-4 p-3">
                <div class="flex items-center mb-3">
                  ...
                  <div class="tracking-wider text-sm sm:text-md md:text-xl">
                    <span class="text-lg pr-1 font-bold">{{number_format($spot['monthly_price_min'])}}</span>円
                    @if($spot['for_check_monthly'])〜@endif
                    @if($spot['monthly_price_max'] > 0)<span class="text-lg pr-1 font-bold">{{number_format($spot['monthly_price_max'])}}</span>
                    円@endif
                  </div>
                </div>
                <div class="flex items-center">
