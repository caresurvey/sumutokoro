...
class SvgBase
{
     ...
     * @return string
     */
    public function findCareIconSvg(string $serial): string
    {
     ...
     * @return string
     */
    public function findOtherIconSvg(string $serial): string
    {
     ...
     * @return string
     */
    public function findTypeSvg(string $type): string
    {
        // 「×」を返す
