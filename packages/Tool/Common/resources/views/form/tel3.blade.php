<div class="flex items-center space-x-2">
  ...
  <input id="{{$id3}}"
         ...
         class="mb-2 appearance-none border w-full text-base block text-gray-700 rounded placeholder-gray-300 p-4 leading-normal focus:outline-primary focus:bg-white @if($hasError3) bg-red-100 text-red-700 placeholder-red-300 border-red-500 @else border-gray-200 bg-gray-100 @endif">
</div>
