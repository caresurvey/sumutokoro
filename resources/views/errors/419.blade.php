...
@section('title', '操作をやり直してください｜' . config('myapp.site_name'))
  ...
  <div class="container mx-auto px-10 py-10 sm:py-24 md:py-36">
    ...
    <div class="py-10">
      <p class="sm:text-md md:text-center md:leading-8">
        申し訳ありません、正しく処理ができませんでした。<br class="hidden md:inline-block">
        手順が違っている可能性があります。<br class="hidden md:inline-block">
        お手数ですが、前のページに戻って更新してからもう一度操作をしてください。
      </p>
    </div>
